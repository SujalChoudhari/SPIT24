...
import { ActivityIcon, ArrowDownToDotIcon, ChevronRightIcon, FileWarning, LineChartIcon, ListTodo, MailWarning, Redo2, SearchIcon, TimerIcon } from "lucide-react";
    ...
    <div key="1" className="flex flex-col w-[80lvw] min-h-screen">
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
        ...
        <Card className="h-full w-[30vw] max-w-xs">
          ...
          <CardContent>
            <BarCharta className="aspect-[3/2]" />
          </CardContent>
        </Card>
        <Card className="h-full w-[30vw] max-w-xs">
          <CardHeader className="grid gap-2">
          ...
          <CardContent>
            <BarChartb className="aspect-[3/2]" />
          </CardContent>
        </Card>
        <Card className="h-full w-[30vw] max-w-xs">
          <CardHeader className="grid gap-2">
          ...
          <CardContent>
            <BarChartc className="aspect-[3/2]" />
          </CardContent>
        </Card>
        <Card className="h-full w-[30vw] max-w-xs">
          <CardHeader className="grid gap-2">
          ...
          <CardContent>
            <BarChartd className="aspect-[3/2]" />
          </CardContent>
        </Card>
        <Card className="h-full w-[30vw] max-w-xs">
          <CardHeader className="grid gap-2">
...
export function analy3() {
    return (
      <Card className="h-full w-[50lvw] max-w-2xl">
        <CardHeader className="grid gap-2">
          <div className="flex items-center gap-2">
            <BarChartIcon className="h-6 w-6" />
