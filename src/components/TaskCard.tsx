...
function TaskCard({ task, deleteTask, updateTask }: Props) {
    ...
    return (
        <div
            ...
            className="[background:radial-gradient(125%_125%_at_50%_10%,#ffffff_40%,#ceccd1_100%)] p-2.5 h-[150px] min-h-[150px]  flex flex-col rounded-xl hover:ring-2 hover:ring-inset hover:ring-rose-500 cursor-grab relative task"
            onMouseEnter={() => {
                setMouseIsOver(true);
            }}
            onMouseLeave={() => {
